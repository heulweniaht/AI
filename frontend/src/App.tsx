  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/booking/:id" element={<AuthGuard><PageWrapper><BookingPage /></PageWrapper></AuthGuard>} />
        ...
        <Route path="*" element={<PageWrapper><div className="min-h-screen pt-24 text-center"><h1 className="text-3xl font-bold">404 Not Found</h1></div></PageWrapper>} />
      </Routes>
    </BrowserRouter>
  );
}
